 ...
 * related tasks.
 */
greenlistApp.service("DatabaseQuery", ["DatabaseRef", "DateRange", "$uibModal", "$window",  function(DatabaseRef, DateRange, $uibModal, $window) {
    ...
    function updateWasteScore(item) {
        var dateStamp = DateRange.getDate();
